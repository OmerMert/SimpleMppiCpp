...
if __name__ == "__main__":
    ...
    print("\nUsage:")
    print("  Set REF_PATH_FILE in config.json (or pass the csv to isaacsim_bridge.py):")
    print('    "REF_PATH_FILE": "data/path_straight.csv"     # simplest')
    print('    "REF_PATH_FILE": "data/path_sine.csv"         # gentle')
    print('    "REF_PATH_FILE": "data/path_wide_oval.csv"    # medium')
    print('    "REF_PATH_FILE": "data/path_large_oval.csv"   # medium-easy')
